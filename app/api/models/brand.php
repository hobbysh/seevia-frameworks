...
//品牌详细
    ...
    public function get_recommended_brand($params=array()){
        ...
        $conditions['Brand.status'] = '1';
        $brand_infos = $this->find('all', array('fields' => array('Brand.id','Brand.url', 'Brand.created', 'BrandI18n.name', 'BrandI18n.description', 'BrandI18n.meta_keywords', 'BrandI18n.img01'), 'conditions' => $conditions, 'order' => $order, 'limit' => $limit));
        return $brand_infos;
    }
}
