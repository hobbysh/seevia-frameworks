...
<script src="<?php echo $webroot; ?>theme/default/js/kefu.js" type="text/javascript"></script>
<div id="kuzhan" class="customer_service am-hide-sm-only" onmouseover="" onmouseout="">
	<div class="services am-fr">
		<div class="kef"><?php echo $ld['contact_customer_service'] ?></div>
		<div class="con" style="border:1px solid #eee;border-bottom-left-radius:10px;">
			<ul>
				<?php if(isset($configs['customer-tel'])&&!empty($configs['customer-tel'])){
				$tel_arr=explode(';',$configs['customer-tel']);?>
				<?php foreach($tel_arr as $v){?>
					<li class="phone">
						<span class="am-icon-phone" style="color:#3bb4f2"></span>&nbsp;<a href="tel:<?php echo $v;?>"><?php echo $v;?></a>
					</li>
				<?php }}?>
...
<style type="text/css">
.bottom_navigations ul.am-dropdown-content:before,.bottom_navigations ul.am-dropdown-content:after{left:74px;}
.bottom_navigations .am-dropdown-header{padding:6px 10px;}
.bottom_navigations li{height:auto;}
.bottom_navigations ul.am-dropdown-content li a{line-height:25px;}
.kef{
	background: #3bb4f2;
	width: 139px;
	font-size: 18px;
