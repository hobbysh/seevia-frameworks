...
<p class="am-u-md-12"><?php echo $html->link($ld['picture_list'],"/image_spaces/",array("class"=>"am-btn am-btn-default am-radius am-btn-xs am-fr"),false,false);?></p>
                    ...
                    <tr><th ><?php echo $ld['upload_picture']?></th>
                        <td>
                            <?php if((isset($configs['image-watermake-upload'])&&$configs['image-watermake-upload']==0)||(!isset($configs['image-watermake-upload']))){
                                ?>
                                <input type="file" class="am-btn" id="file_upload" name="file_upload" />
                            <?php }else{ ?>
