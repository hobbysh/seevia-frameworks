...
<li style="display: inline-block;margin: 10px;vertical-align: top;">
	...
	<a class="img" href="javascript:void(0)">
			<?php echo $html->image((!stristr($image_data['img']['img_small'],IMG_HOST)?IMG_HOST.$image_data['img']['img_small']:$image_data['img']['img_small']),array('id'=>'img1','style'=>'width: 120px; height: 120px;','onclick'=>"selected_image(this,'".$image_data['img']['img_detail']."','".$image_data['img']['img_original']."','".$image_data['img']['name']."')"));  ?></a>
