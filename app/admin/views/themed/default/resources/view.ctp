	...
	<div class="am-panel-group am-u-lg-10 am-u-md-9 am-u-sm-8" id="accordion">
		 <div class="am-panel am-panel-default">
		    ...
		    <div id="basic_information" class="am-panel-collapse am-collapse am-in">
				...
				<!--版本-->
					<div class="am-form-group" >
						<div class="am-u-lg-2 am-u-md-3 am-u-sm-3 am-form-label" style="top:2px"><?php echo $ld['version'];?></div>
						<div class="am-u-lg-5 am-u-md-6 am-u-sm-8">
					...
					<!--是否可用-->
					<div class="am-form-group">
						<div class="am-u-lg-2 am-u-md-3 am-u-sm-3 am-form-label" style="top:0px"><?php echo $ld['availability'];?></div>
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-8">
