		    ...
		    <div id="basic_information" class="am-panel-collapse am-collapse am-in">
		      	<div class="am-panel-bd am-form-detail am-form am-form-horizontal">
					...
					<div class="am-form-group">
						<div class="am-u-lg-2 am-u-md-3 am-u-sm-3 am-form-label am-form-align"><?php echo $ld['resource_name'];?></div>
					...
					<div class="am-form-group">
						<div class="am-u-lg-2 am-u-md-3 am-u-sm-3 am-form-label am-form-align"><?php echo $ld['parent_resource'];?></div>
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-8">
					...
					<div class="am-form-group">
						<div class="am-u-lg-2 am-u-md-3 am-u-sm-3 am-form-label am-form-align"><?php echo $ld['r_description'];?></div>
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-8">
					...
					<div class="am-form-group">
						<div class="am-u-lg-2 am-u-md-3 am-u-sm-3 am-form-label am-form-align"><?php echo $ld['resource_code'];?></div>
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-8">
							<div class="am-u-lg-10 am-u-md-10 am-u-sm-10">
					...
					<div class="am-form-group">
						<div class="am-u-lg-2 am-u-md-3 am-u-sm-3 am-form-label am-form-align"><?php echo $ld['z_resource_value'];?></div>
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-8">
							<div class="am-u-lg-10 am-u-md-10 am-u-sm-10">				
				...
				<!--版本-->
					<div class="am-form-group">
						<div class="am-u-lg-2 am-u-md-3 am-u-sm-3 am-form-label am-form-align"><?php echo $ld['version'];?></div>
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-8">
					...
					<div class="am-form-group">
						...
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-8" style="padding-left:10px">
					...
					<!--排序-->
					<div class="am-form-group">
						<div class="am-u-lg-2 am-u-md-3 am-u-sm-3 am-form-label am-form-align"><?php echo $ld['sort'];?></div> 
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-8">
							<div class="am-u-lg-10 am-u-md-10 am-u-sm-10">
