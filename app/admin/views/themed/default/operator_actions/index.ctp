...
.am-panel-bd {padding: 0.5rem;}
 .am-yes{color:#5eb95e;}
 .am-no{color:#dd514c;}
#accordion div .am-panel-body .am-panel-bd div .am-icon-plus+a{color:#333!important}
#accordion div .am-panel-body .am-panel-bd div .am-icon-minus+a{color:#333!important}


</style>
<div class="am-other_action">
	<div class="am-g am-text-right" style="margin-bottom:10px;">
		...
		<div class="am-panel am-panel-default am-panel-body" style="border-top-width:0px;" >
		    <div class="am-panel-bd fuji">
				...
				<div class="am-u-lg-2 am-u-md-2 am-u-sm-2">
				    ...
				    <a class="am-btn am-delaction am-btn-default am-text-danger am-btn-sm am-radius" href="javascript:void(0);" onclick="list_delete_submit('<?php echo $admin_webroot; ?>operator_actions/remove/<?php echo $v['OperatorAction']['id']; ?>')">
				    	<?php echo $ld['delete']; ?>
				    </a>
				</div>
				<div style="clear:both;"></div>
		    ...
		    <div class="am-panel-collapse am-collapse am-panel-child" id="action_<?php echo $v['OperatorAction']['id']?>">
				...
				<div class="am-panel-bd am-panel-childbd actionn_<?php echo $vv['OperatorAction']['id']?>">
					...
					<div class="am-u-lg-2 am-u-md-2 am-u-sm-2">
						...
						<?php echo $html->link($ld['delete'],"javascript:;",array("class"=>"am-btn am-btn-default am-text-danger am-delaction am-btn-sm am-radius am-text-left","onclick"=>"list_delete_submit('{$admin_webroot}operator_actions/remove/{$vv['OperatorAction']['id']}')"));?>
					</div>
					<div style="clear:both;"></div>
		    	</div>
		<!--三级 菜单-->			
