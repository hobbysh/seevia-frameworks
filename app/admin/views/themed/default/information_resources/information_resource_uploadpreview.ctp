...
<?php echo $form->create('information_resources',array('action'=>'/information_resource_uploadpreview/','name'=>"theForm"));?>
...
{
document.theForm.action=admin_webroot+"information_resources/information_resource_uploadpreview";
