		      	...
		      	<div class="am-panel-bd am-form-detail am-form am-form-horizontal">
					...
					<div class="am-form-group">
						...
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-8">
				  		<?php if(isset($backend_locales) && sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
							<div class="am-u-lg-10 am-u-md-10 am-u-sm-10" style="margin-bottom:2px;">
					...
					<div class="am-form-group">
						...
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-9">
							<select data-am-selected="{btnWidth:200,maxHeight:300, btnSize: 'default ', btnStyle: '#CCCCCC'}" name="data[InformationResource][parent_id]">
