...
<?php echo $form->create('api_methods',array('action'=>'/error_code_interpretation_uploadpreview/','name'=>"theForm"));?>
	...
	<table id="t1" class="am-table  table-main">
		...
		<tr>
			...
			<?php foreach($key_arr as $kk => $vv){?>
				<?php  //pr($key_arr);?>
				<td><input type='text' class="user_<?php echo""?>" name="data[<?php echo $k?>][<?php echo $key_arr[$kk]?>]" value="<?php echo isset($v[$vv])?$v[$vv]:'';?>" /></td>
			<?php }?>
