<div class="am-u-lg-3 am-u-md-4 am-u-sm-12 am-user-menu am-hide-sm-only">
...
<!-- 头像编辑链接浮动窗口 -->
      ...
      <li class="admin-parent">
        ...
        <ul id="collapse-nav" class="am-list am-collapse admin-sidebar-sub am-in">
          <li><a class="am-cf" href="<?php echo $html->url('/users/index'); ?>"><span class="am-icon-user"></span>&nbsp;<?php echo $ld['user_center'] ?><span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
          <li><a class="am-cf" href="<?php echo $html->url('/users/edit'); ?>"><span class="am-icon-pencil-square-o"></span>&nbsp;<?php echo $ld['account_profile'] ?></a></li>
		  ...
		  <li><a href="<?php echo $html->url('/users/enquiries'); ?>"><span class="am-icon-table"></span>&nbsp;<?php echo $ld['enquiry'] ?></a></li><?php } ?>
        </ul>
      </li>
      ...
      <?php } ?>     
            <li><a href="<?php echo $html->url('/websites/sites'); ?>"><span class="am-icon-sign-out"></span>&nbsp;<?php echo $ld['Site_list'] ?></a></li>
     <li><a href="<?php echo $html->url('/websites/versions'); ?>"><span class="am-icon-sign-out"></span>&nbsp;<?php echo $ld['Open_the_service'] ?></a></li>
