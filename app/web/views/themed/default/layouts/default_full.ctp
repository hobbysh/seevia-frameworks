...
<script src="<?php echo $webroot; ?>plugins/AmazeUI/js/amazeui.min.js" type="text/javascript"></script>
<script src="<?php echo $webroot; ?>plugins/AmazeUI/js/amazeui.lazyload.min.js" type="text/javascript"></script>
<?php
	//加载js
...
?>
<!-- content -->
<?php if(($this->params['controller']=="products" && $this->params['action']="view")|| $this->params['controller']=="categories" || $this->params['controller']=="topics" || $this->params['controller']=="articles" || $this->params['controller']=="brands" || $this->params['controller']=="carts" || $this->params['controller']=="promotions"){ ?>
